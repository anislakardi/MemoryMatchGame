...
public class huhu extends javax.swing.JFrame {
     ...
     */
    String[] tableDeCouleur = {"red", "red", "green", "green", "blue", "blue", "orange", "orange", "yellow", "yellow", "PINK", "PINK"};
   ...
   public static String[] shuffleArray(String[] table) {
    ...
    private void bRejouerActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
        carteS = Fonctions.shuffleButtons(carteS);enableAllButtons(carteS);
        cartes = Fonctions.shuffleButtons(cartes);enableAllButtons(cartes);
        carteSS = Fonctions.shuffleButtons(carteSS);enableAllButtons(carteSS);
        score = 0;
        LScore.setText(String.valueOf(score));
    }                                        

    private void difficulteActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    ...
    private void carte2ActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
        String choix = (String)difficulte.getSelectedItem();
        switch(choix){
    ...
    private void carte3ActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
        String choix = (String)difficulte.getSelectedItem();
        switch(choix){
    ...
    private void carte6ActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
        String choix = (String)difficulte.getSelectedItem();
        switch(choix){
    ...
    private void carte7ActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
        String choix = (String)difficulte.getSelectedItem();
        switch(choix){
    ...
    private void carte5ActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
        String choix = (String)difficulte.getSelectedItem();
        switch(choix){
    ...
    private void carte8ActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
        String choix = (String)difficulte.getSelectedItem();
        switch(choix){
    ...
    private void carte9ActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
        String choix = (String)difficulte.getSelectedItem();
        switch(choix){
    ...
    private void carte10ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
        String choix = (String)difficulte.getSelectedItem();
        switch(choix){
    ...
    private void carte11ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
        String choix = (String)difficulte.getSelectedItem();
        switch(choix){
    ...
    private void carte12ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
        String choix = (String)difficulte.getSelectedItem();
        switch(choix){
    ...
    private void carte1ActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
        compare4(carte1,cartes);
    }                                      

    private void carte4ActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
...
public static void setButtonColor(JButton button, String colorName) {
        switch (colorName) {
            ...
            case "yellow":
                ...
                break;
            case "PINK":
                button.setBackground(Color.PINK); // Pas de constante pré-définie pour violet
                break;
        }
    }
